...
MAX_SIMULATION_YEARS: int = 1000  # Automatically stops the simulation after this many years
TIME_ACCELERATION: int = int(1e8)  # default = 1e6
...
TO_SCALE: bool = False
SHOW_GRAPHICAL_VIEW: bool = False  # Setting to True makes the program run much slower and will be affected by lag
